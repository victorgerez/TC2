...
# Calculamos transferencia desnormalizada:

num_hp_desn = num_hp
den_hp_desn = den_hp * [1,norm_w,norm_w*norm_w]

t_hp_desn = sig.TransferFunction(num_hp_desn, den_hp_desn)

#-------------------------------------------------------------------------------------------------------------------#

# Imprimimos la T(s) desnormalizada en formato T(s)= num/den con la funcion pretty_print_lti(num, den):

print(' ')
print('-- Función transferencia T(s) analítica desnormalizada: --')
print(' ')

pretty_print_lti(num_hp_desn, den_hp_desn)
...
analyze_sys(t_hp_desn, sys_name='Filtro pasa alto Chebyshev 2do orden desnormalizado')
